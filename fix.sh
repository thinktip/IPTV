...
# ==============================================================================
# DSM 7.2 CPU Info Changer for AMD Ryzen 3 2200G
#
# 免责声明:
...
clear
echo "============================================================"
echo "      DSM 7.2 CPU 信息修改脚本 (for AMD Ryzen 3 2200G)      "
echo "============================================================"
echo
...
# 寻找 `ds_model` 项并在其后插入新的CPU信息块
sed -i "s/\"ds_model\")},/\"ds_model\")},${CPU_INFO_MOBILE}/g" "${MOBILE_JS_WORK}"
